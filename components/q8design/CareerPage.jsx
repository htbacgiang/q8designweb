  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="q8-hero-section relative h-[45vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-7xl mx-auto px-2">
          <h1 className="text-2xl md:text-5xl font-bold mb-3">
            Kiến tạo giá trị, <br />
            <span className="">Xây dựng sự nghiệp</span> cùng Q8 Design
          </h1>
          <p className="text-xl hidden md:block max-w-3xl mx-auto leading-relaxed text-q8-primary-200 max-w-3xl mx-auto leading-relaxed">
            ...
            {companyValues.map((value, index) => {
              ...
              return (
                <div key={index} className="text-center group">
                  <div className="w-16 h-16 bg-q8-primary-50 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-300">
                    <Icon className="text-2xl text-[#c4a77d] transition-colors duration-300" />
                  </div>
              ...
              <div key={position.id} className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-[#c4a77d] hover:bg-q8-primary-700 text-white font-bold py-3 px-3 rounded-full transition-colors duration-300"
                  >
                    Xem chi tiết
                  </button>
                  <button
                    ...
                    className="flex-1 border-2 border-q8-primary-900 text-q8-primary-900 hover:bg-q8-primary-900 hover:text-white font-bold py-3 px-3 rounded-full transition-all duration-300"
                  >
                    Ứng tuyển ngay
                  </button>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-[#c4a77d] rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl">
                  {item.step}
                </div>
                <h3 className="text-xl font-bold text-q8-primary-900 mb-3">
                  {item.title}
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="inline-flex items-center px-5 py-3 bg-[#c4a77d] text-white font-bold rounded-full hover:bg-q8-primary-700 transition-colors duration-300"
              >
              ...
              <a
                ...
                download
                className="inline-flex items-center px-5 py-3 border-2 border-q8-primary-900 text-q8-primary-900 font-bold rounded-full hover:bg-q8-primary-900 hover:text-white transition-all duration-300"
              >
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleApplicationSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-q8-primary-300 rounded-xl p-4 text-center hover:border-q8-primary-900 transition-colors">
                    <input
                      type="file"
                      name="cv"
                      required
                ...
                <div className="flex space-x-4">
                  <button
                    type="submit"
                    className="flex-1 bg-[#c4a77d] hover:bg-q8-primary-700 text-white font-bold py-3 px-6 rounded-full transition-colors duration-300"
                  >
                    Gửi đơn ứng tuyển
                  </button>
                  <button
