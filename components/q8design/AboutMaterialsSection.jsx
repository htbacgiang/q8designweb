        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start lg:items-stretch">
          ...
          <div className="space-y-10">
            ...
            <motion.div
              ...
              className="max-w-2xl"
            >
              <h3 className="font-serif text-2xl md:text-3xl font-bold text-neutral-900 leading-tight">
                Vật liệu tử tế cho 
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-md p-6 shadow-xl ">
              ...
              <p className="text-neutral-900 font-serif font-bold text-sm">KTS Q8 Desgin tư vấn chọn vật cho khách hàng</p>
            </div>
          </motion.div>
        </div>
      </div>
