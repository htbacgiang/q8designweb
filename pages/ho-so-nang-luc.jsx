        ...
        <div className="container mx-auto px-4 py-6 md:py-8">
          <div className="flex items-center justify-between gap-4 mb-8 flex-col md:flex-row">
            ...
            >
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2 transition-all ${
                  active === "hsnl"
                    ? "bg-q8-primary-900 text-white shadow"
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-q8-primary-900 hover:bg-q8-primary-700 text-white text-sm font-semibold shadow"
            >
